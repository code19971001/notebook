...
![image-20210209103817324](https://gitee.com/code1997/blog-image/raw/master/images/image-20210209103817324.png)
...
3）hbase中添加列，hive是否可以查询到？

```shell
put 'hbase_emp_table','1111','info:bo','222'
scan 'hbase_emp_table'
```

![image-20210209101338458](https://gitee.com/code1997/blog-image/raw/master/images/image-20210209101338458.png)



![image-20210209101513028](https://gitee.com/code1997/blog-image/raw/master/images/image-20210209101513028.png)结论：hbase中添加列，hive中可以查询到。